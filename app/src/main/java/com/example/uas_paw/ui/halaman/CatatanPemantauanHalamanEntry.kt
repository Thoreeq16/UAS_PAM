...
import com.example.uas_paw.model.DetailCatatanPemantauan
import com.example.uas_paw.model.PenyediaViewModel
import com.example.uas_paw.model.CatatanPemantauanEntryViewModel
import com.example.uas_paw.model.UIStateCatatanPemantauan
...
fun EntryCatatanPemantauanScreen(
    navigateBack: () -> Unit,
    navigateBackCatatanPemantauan: () -> Unit,
    ...
    Scaffold(
        ...
        topBar = {
            GreenGuardianTopAppBar(
                ...
                navigateUp = navigateBackCatatanPemantauan
            )
        }
    ) { innerPadding ->
