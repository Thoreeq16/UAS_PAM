...
import com.example.uas_paw.model.DetailTanaman
import com.example.uas_paw.model.PenyediaViewModel
import com.example.uas_paw.model.TanamanEntryViewModel
import com.example.uas_paw.model.UIStateTanaman
    ...
    Scaffold(
        ...
        topBar = {
            GreenGuardianTopAppBar(
                ...
                navigateUp = navigateBackTanaman
            )
        }
    ) { innerPadding ->
        EntryTanamanBody(
