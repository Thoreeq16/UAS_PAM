...
import com.example.uas_paw.model.TanamanHomeViewModel
...
object DestinasiTanamanHome : DestinasiNavigasi {
    override val route = "tanaman_home"
    ...
    Scaffold(
        modifier = modifier.nestedScroll(scrollBehavior.nestedScrollConnection), topBar = {
            GreenGuardianTopAppBar(
                title = stringResource(id = DestinasiTanamanHome.titleRes),
        ...
        val uiStateTanaman by viewModel.TanamanHomeUiState.collectAsState()
        BodyHome(
            modifier = Modifier
