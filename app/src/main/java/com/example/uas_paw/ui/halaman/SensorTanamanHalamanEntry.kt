...
import com.example.uas_paw.model.DetailSensorTanaman
import com.example.uas_paw.model.PenyediaViewModel
import com.example.uas_paw.model.SensorTanamanEntryViewModel
import com.example.uas_paw.model.UIStateSensorTanaman
...
fun EntrySensorTanamanScreen(
    navigateBack: () -> Unit,
    navigateBackSensorTanaman: () -> Unit,
    ...
    Scaffold(
        ...
        topBar = {
            GreenGuardianTopAppBar(
                ...
                navigateUp = navigateBackSensorTanaman
            )
        }
    ) { innerPadding ->
